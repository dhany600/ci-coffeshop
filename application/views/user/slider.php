            <section class="uk-position-relative uk-visible-toggle uk-light" uk-slideshow="min-height: 300; max-height: 600;">
                <ul class="uk-slideshow-items">
                    <li style="background-color: #0b0a12"><a href="#">
                            <figure class="uk-container uk-height-1-1"><img src="<?= base_url()?>assets/template-user/images/promo/macbook-new.jpg" alt="New Macbook" width="1200" height="600" uk-cover></figure>
                        </a></li>
                    <li style="background-color: #ce071e"><a href="#">
                            <figure class="uk-container uk-height-1-1"><img src="<?= base_url()?>assets/template-user/images/promo/iphone.jpg" alt="iPhone" width="1200" height="600" uk-cover></figure>
                        </a></li>
                    <li style="background-color: #1f2024"><a href="#">
                            <figure class="uk-container uk-height-1-1"><img src="<?= base_url()?>assets/template-user/images/promo/ipad.jpg" alt="iPad" width="1200" height="600" uk-cover></figure>
                        </a></li>
